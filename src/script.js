...
const floor = new THREE.Mesh(
  new THREE.PlaneGeometry(20, 20, 100, 100), //more segments for displacement texture
...
walls.position.y += 2.5 / 2; // y-size/2
house.add(walls);
...
roof.position.y = 2.5 + 0.75; //wall size+ 1/2 of roof
...
door.position.y = 1;
door.position.z = 2 + 0.01; //to avoid z-fighting
house.add(door);
...
directionalLight.shadow.mapSize.height = 256 //for blurring
directionalLight.shadow.mapSize.height = 256
directionalLight.shadow.camera.top = 8
directionalLight.shadow.camera.right = 8
directionalLight.shadow.camera.bottom = - 8
directionalLight.shadow.camera.left = - 8 //to enlarge camera amplitude to not cut shadows
directionalLight.shadow.camera.near = 1
directionalLight.shadow.camera.far = 20 // optimizations - to have lesser glitches in shadow
...
sky.material.uniforms['sunPosition'].value.set(0.3, -0.038, -0.95) //uniforms relevant for shaders
